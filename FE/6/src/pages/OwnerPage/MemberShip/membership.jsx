  ...
  return (
    <div className="membership-container">
      <div className="membership-header">
        ...
        <img src={require("../../../assets/images/room0.png")} alt="House Icon" className="house-icon" />
      </div>
      <div className="plans">
      ...
      <div className="upgrade-section">
        ...
        <div className="upgrade-images">
          <img src={require("../../../assets/images/room0.png")} alt="Membership Card" className="membership-card" />
          <img src={require("../../../assets/images/room1.png")} alt="Team Meeting" className="team-meeting" />
          <img src={require("../../../assets/images/room2.png")} alt="Happy Owner" className="happy-owner" />
        </div>
      </div>
    </div>
  );
